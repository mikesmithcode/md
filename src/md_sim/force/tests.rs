...
mod tests {
    ...
    use crate::md_sim::utils::test_utils::create_particle_vec;
    use crate::md_sim::utils::models::CollisionParams;
    
    use super::super::single::add_weight;
    use super::super::single::add_viscous_drag;
    use super::super::single::add_active_force;

    use super::super::pairwise::add_granular_collision;
    use super::super::pairwise::add_coulomb;
    use super::super::pairwise::add_weeks_chandler_andersen;

    use super::super::utils::check_delta;

    use super::super::neighbours::CellGrid;
    ...
    fn test_coulomb() {
        ...
        add_coulomb(0, 1, &particles, &mut forces, &mut torques, &settings);

        const EPS0: f64 = 8.85418782e-12;
        let separation = particles.position[0]-particles.position[1];
        let coulomb_force = (1/(4*PI*EPS0))*-1.0/separation;
        println!("coulomb {:?}", coulomb_force);
        assert_eq!(forces[0], coulomb_force);
