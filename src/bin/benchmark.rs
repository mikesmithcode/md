...
/// 
/// This script is used to run the benchmark. A disordered packing of spheres subject to a 30deg to vertical gravitational force
/// since there are a constrained layer of particles at the bottom this causes a steady shear flow.
