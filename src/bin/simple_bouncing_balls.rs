...
use md::md_sim::motion::motion::{integrate_singleparticle_update, integrate_singleparticle_correct, move_sinwave, change_colour};
...
impl Motion for SimUpdate{
    fn update_motion(&self, forces: &[glam::DVec3], _torques: &[DVec3], particles: &mut ParticleVec,settings: &SimulationSettings, _molecule_map: &HashMap<usize, Vec<usize>>, time:f64) {
