...
use md::md_sim::motion::{MoleculeData, change_colour, integrate_singleparticle_correct, integrate_singleparticle_update, move_sinwave};
...
impl Motion for SimUpdate{
    fn update_motion(&self, forces: &[glam::DVec3], _torques: &[DVec3], particles: &mut ParticleVec,settings: &SimulationSettings, _molecule_map: &HashMap<usize, MoleculeData>, time:f64) {
