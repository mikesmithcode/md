...
- [Orthographic](../src/md_viz/camera.rs). - this camera has no perspective everything looks the same size regardless of how far from the camera it is. There is no parallax error as a result.
